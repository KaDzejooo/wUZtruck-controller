...
/* Definitions for taskIO */
osThreadId_t taskIOHandle;
const osThreadAttr_t taskIO_attributes = {
  .name = "taskIO",
  .stack_size = 512 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for videoDecode */
osThreadId_t videoDecodeHandle;
const osThreadAttr_t videoDecode_attributes = {
  .name = "videoDecode",
  .stack_size = 128 * 4,
...
/* Definitions for integrityMngr */
osThreadId_t integrityMngrHandle;
const osThreadAttr_t integrityMngr_attributes = {
  .name = "integrityMngr",
  .stack_size = 512 * 4,
  .priority = (osPriority_t) osPriorityRealtime,
};
...
extern void StartTaskIO(void *argument);
extern void StartVideoDecode(void *argument);
extern void StartUartComms(void *argument);
extern void StartIntegrityMngr(void *argument);
void Callback01(void *argument);

/* USER CODE BEGIN PFP */
// define new task to play audio
// pass audio commands via queue
// done
//
/* USER CODE END PFP */
...
/* Configure the peripherals common clocks */
  ...
  /* creation of taskIO */
  taskIOHandle = osThreadNew(StartTaskIO, NULL, &taskIO_attributes);

  /* creation of videoDecode */
  videoDecodeHandle = osThreadNew(StartVideoDecode, NULL, &videoDecode_attributes);

  /* creation of uartComms */
  uartCommsHandle = osThreadNew(StartUartComms, NULL, &uartComms_attributes);

  /* creation of integrityMngr */
  integrityMngrHandle = osThreadNew(StartIntegrityMngr, NULL, &integrityMngr_attributes);
 ...
 //HAL_ADC_Start_DMA(&hadc3,axis3,3);
